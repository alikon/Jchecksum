...
/**
 * Zoombie Extension Finder Indexer task plugin
 * Embedd Extension Finder Indexer ! 
 *
 * @author:  Alikon
 * @version:  1.1.1
 ...
 *
 * @based on
 * Finder indexer - Joomla! CLI Script
 * 
 *
 * */
// no direct access
...
class plgZoombieIndexer extends JPlugin {
    ...
    function goAliveIndexer($time) {
        ...
        $this->lang->load('finder_cli', JPATH_SITE, null, false, false) || $lang->load('finder_cli', JPATH_SITE, null, true);
